...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary bg-black elevation-4 sidebar-no-expand">
        ...
        <span class="brand-text fw-bolder nav-text text"><?php echo $_settings->info('short_name') ?></span>
        </a>
        <!-- Sidebar -->
              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                  <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    <li class="nav-item c-nav-item dropdown">
    ...
    $(document).ready(function(){
      ...
      $('.nav-link.active').addClass('bg-navy')
    })
  </script>